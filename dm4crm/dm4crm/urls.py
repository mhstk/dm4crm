...
urlpatterns = [
    ...
    path('defualtDisconnectNode/', views.default_disconnect_node),
    path('<node_id>/schema/', views.get_schema),
    path('<node_id>/show/', views.show),
    path('<node_id>/edit/', views.edit_node),
    path('<node_id>/view/', views.view_node),
    path('<node_id>/remove/', views.remove),
    path('stream/', views.streamed),
    path('save/', views.save_ws),
    path('setNodesPos/', views.set_nodes_pos),
    path('settings/', views.settings),
    path('load/', views.load_ws),
]
